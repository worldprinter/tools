...
import type { ExecutorContext, ProjectGraph, ProjectGraphProjectNode } from '@nrwl/devkit'
import {
...
export default async function runExecutor(
    ...
    const bundableDependencies = nonBuildableDependencies.map((dependencyName: string) =>
